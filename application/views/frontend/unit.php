        ...
        <div class="col-lg-8 col-md-8">
            <div class="card text-black mb-3" style="max-width: 100%;">
                <div class="card-header text-white" style="background: #288ACB;">
                    <h6 class="m-0"><b><i class="fa fa-book"></i>&emsp; PRODUK HUKUM <?= strtoupper($nama_unit['nama_unit']); ?></b></h6>
                </div>
                <div class="card-body">
                    <?php if ($prohum == null) { ?>
        ...
        <div class="col-lg-4 col-md-4">
            <div class="row">
                <div class="col-md-12">
                    <div class="card text-black mb-3" style="max-width: 100%;">
                        <div class="card-header text-white" style="background: #288ACB;">
                            <h6 class="m-0"><b><i class="fa fa-list-ul"></i>&emsp; KATEGORI PRODUK HUKUM</b></h6>
                        </div>
                        <div class="card-body">
                            <?php if ($katProduk == null) { ?>
                                <div class="alert alert-warning" role="alert">
                                    <i class="fa fa-close"></i>&emsp; Kategori Produk Hukum Tidak Ditemukan
                                </div>
                            <?php } ?>
                            <?php foreach ($katProduk as $val) { ?>
                                <div class="kategori">
                                    <div class="col-md-12">
                                        <div class="row">
                                            <div class="kategori-icon" style="float: left;">
                                                <center><i class="fa fa-th-large"></i></center>
                                            </div>
                                            <div class="kategori-content" style="float: right;">
